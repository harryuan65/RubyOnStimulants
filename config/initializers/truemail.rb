...
Truemail.configuration do |config|
    config.verifier_email = 'harry@gopaktor.com'
    ...
    config.logger = { tracking_event: :all, stdout: true, log_absolute_path: '~/documents/Ruby_on_rails/truemail_log/truemail.log' }
    puts "Set!!!"
end